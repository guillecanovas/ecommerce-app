              ...
              <div className="item-desc">
                ...
                <div className="flex bottom">
                  ...
                  <p className="quantity-desc">
                    <span className="minus" onClick={() => toggleCartItemQuanitity(item._id, 'restar') }>
                    <AiOutlineMinus />
                    </span>
                    <span className="num" onClick="">{item.quantity}</span>
                    <span className="plus" onClick={() => toggleCartItemQuanitity(item._id, 'sumar') }><AiOutlinePlus /></span>
                  </p>
                  </div>
                  <button
                    type="button"
