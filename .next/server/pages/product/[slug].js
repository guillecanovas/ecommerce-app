...
/* al hacer con "[]" lo hacemos dinamicamente */ /* no hace falta crear ningun router */ /* http://localhost:3000/product/headphones */ 
...
const ProductDetails = ({ product , products  })=>{
    ...
    const { restarCantidad , sumarCantidad , qty , onAdd , setShowCart  } = (0,_context_StateContext__WEBPACK_IMPORTED_MODULE_5__/* .useStateContext */ .F)();
    const handleBuyNow = ()=>{
        onAdd(product, qty);
...
const getStaticProps = async ({ params: { slug  }  })=>{
    ...
    const product = await _lib_client__WEBPACK_IMPORTED_MODULE_3__/* .client.fetch */ .L.fetch(query); //conseguimos el producto individual
    const products = await _lib_client__WEBPACK_IMPORTED_MODULE_3__/* .client.fetch */ .L.fetch(productsQuery); //query de productos
    return {
        props: {
            products,
            product
...
var __webpack_exports__ = __webpack_require__.X(0, [676,664,996,932], () => (__webpack_exec__(8846)));
